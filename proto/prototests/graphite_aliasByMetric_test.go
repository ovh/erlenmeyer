...
// go test proto/prototests/graphite_aliasByMetric_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAliasByMetric process Invert Graphite Unit tests
func TestGraphiteAliasByMetric(t *testing.T) {
	RunTest(t, graphiteGraphiteAliasByMetric, "")
}

var graphiteGraphiteAliasByMetric = []unitTests{
