...
// go test proto/prototests/graphite_aliasByNode_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAliasByNode process Invert Graphite Unit tests
func TestGraphiteAliasByNode(t *testing.T) {
	RunTest(t, graphiteGraphiteAliasByNode, "")
}

var graphiteGraphiteAliasByNode = []unitTests{

	{
		Plan: []graphite.Function{
			{
				Name:       "aliasByNode",
				Arguments:  []string{"SWAP", "1"},
