...
// go test proto/prototests/graphite_aliasByTags_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAliasByTags process Invert Graphite Unit tests
func TestGraphiteAliasByTags(t *testing.T) {
	RunTest(t, graphiteGraphiteAliasByTags, "")
}

var graphiteGraphiteAliasByTags = []unitTests{

	{
		Plan: []graphite.Function{
			{
				Name:       "aliasByTags",
				Arguments:  []string{"SWAP", "label"},
