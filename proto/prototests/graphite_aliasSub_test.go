...
// go test proto/prototests/graphite_aliasSub_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAliasSub process Invert Graphite Unit tests
func TestGraphiteAliasSub(t *testing.T) {
	RunTest(t, graphiteGraphiteAliasSub, "")
}

var graphiteGraphiteAliasSub = []unitTests{

	{
		Plan: []graphite.Function{
			{
				Name:       "aliasSub",
				Arguments:  []string{"SWAP", "empty", "sample"},
