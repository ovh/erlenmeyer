...
// go test proto/prototests/graphite_alias_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAlias process Invert Graphite Unit tests
func TestGraphiteAlias(t *testing.T) {
	RunTest(t, graphiteGraphiteAlias, "")
}

var graphiteGraphiteAlias = []unitTests{
