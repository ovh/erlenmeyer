...
// go test proto/prototests/graphite_averageAbove_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAverageAbove process Invert Graphite Unit tests
func TestGraphiteAverageAbove(t *testing.T) {
	RunTest(t, graphiteGraphiteAverageAbove, "")
}

var graphiteGraphiteAverageAbove = []unitTests{
