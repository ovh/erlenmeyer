...
// go test proto/prototests/graphite_averageBelow_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAverageBelow process Invert Graphite Unit tests
func TestGraphiteAverageBelow(t *testing.T) {
	RunTest(t, graphiteGraphiteAverageBelow, "")
}

var graphiteGraphiteAverageBelow = []unitTests{

	{
		Plan: []graphite.Function{
			{
				Name:       "averageBelow",
				Arguments:  []string{"SWAP", "20"},
