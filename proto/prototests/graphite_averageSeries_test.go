...
// go test proto/prototests/graphite_averageSeries_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteAverageSeries process Invert Graphite Unit tests
func TestGraphiteAverageSeries(t *testing.T) {
	RunTest(t, graphiteGraphiteAverageSeries, "")
}

var graphiteGraphiteAverageSeries = []unitTests{
