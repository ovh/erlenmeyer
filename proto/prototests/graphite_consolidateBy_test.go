...
// go test proto/prototests/graphite_consolidateBy_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteConsolidateBy process Invert Graphite Unit tests
func TestGraphiteConsolidateBy(t *testing.T) {
	RunTest(t, graphiteGraphiteConsolidateBy, "")
}

var graphiteGraphiteConsolidateBy = []unitTests{
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"consolidate": "mean"},
			},
		},
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"consolidate": "median"},
			},
		},
		Samples: []OperatorGTSTest{
			{
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"consolidate": "min"},
			},
		},
		Samples: []OperatorGTSTest{
			{
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"consolidate": "max"},
			},
		},
		Samples: []OperatorGTSTest{
			{
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"consolidate": "count"},
			},
		},
		Samples: []OperatorGTSTest{
			{
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"consolidate": "product"},
			},
		},
		Samples: []OperatorGTSTest{
			{
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"consolidate": "last"},
			},
		},
		Samples: []OperatorGTSTest{
			{
