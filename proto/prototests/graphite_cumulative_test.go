...
// go test proto/prototests/graphite_cumulative_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteCumulative process Invert Graphite Unit tests
func TestGraphiteCumulative(t *testing.T) {
	RunTest(t, graphiteGraphiteCumulative, "")
}

var graphiteGraphiteCumulative = []unitTests{
