...
// go test proto/prototests/graphite_currentBelow_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteCurrentBelow process Invert Graphite Unit tests
func TestGraphiteCurrentBelow(t *testing.T) {
	RunTest(t, graphiteGraphiteCurrentBelow, "")
}

var graphiteGraphiteCurrentBelow = []unitTests{
