...
// go test proto/prototests/graphite_diffSeries_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteDiffSeries process Invert Graphite Unit tests
func TestGraphiteDiffSeries(t *testing.T) {
	RunTest(t, graphiteGraphiteDiffSeries, "")
}

var graphiteGraphiteDiffSeries = []unitTests{
