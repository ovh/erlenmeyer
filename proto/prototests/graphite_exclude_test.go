...
// go test proto/prototests/graphite_exclude_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteExclude process Invert Graphite Unit tests
func TestGraphiteExclude(t *testing.T) {
	RunTest(t, graphiteGraphiteExclude, "")
}

var graphiteGraphiteExclude = []unitTests{

	{
		Plan: []graphite.Function{
			{
				Name:       "exclude",
				Arguments:  []string{"SWAP", "empty"},
