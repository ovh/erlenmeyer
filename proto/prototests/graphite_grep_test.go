...
// go test proto/prototests/graphite_grep_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteGrep process Invert Graphite Unit tests
func TestGraphiteGrep(t *testing.T) {
	RunTest(t, graphiteGraphiteGrep, "")
}

var graphiteGraphiteGrep = []unitTests{

	{
		Plan: []graphite.Function{
			{
				Name:       "grep",
				Arguments:  []string{"SWAP", "sample"},
