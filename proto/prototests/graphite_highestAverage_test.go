...
// go test proto/prototests/graphite_highestAverage_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteHighestAverage process Invert Graphite Unit tests
func TestGraphiteHighestAverage(t *testing.T) {
	RunTest(t, graphiteGraphiteHighestAverage, "")
}

var graphiteGraphiteHighestAverage = []unitTests{
