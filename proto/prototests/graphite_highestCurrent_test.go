...
// go test proto/prototests/graphite_highestCurrent_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteHighestCurrent process Invert Graphite Unit tests
func TestGraphiteHighestCurrent(t *testing.T) {
	RunTest(t, graphiteGraphiteHighestCurrent, "")
}

var graphiteGraphiteHighestCurrent = []unitTests{
