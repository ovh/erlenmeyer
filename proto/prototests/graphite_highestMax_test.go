...
// go test proto/prototests/graphite_highestMax_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteHighestMax process Invert Graphite Unit tests
func TestGraphiteHighestMax(t *testing.T) {
	RunTest(t, graphiteGraphiteHighestMax, "")
}

var graphiteGraphiteHighestMax = []unitTests{
