...
// go test proto/prototests/graphite_interpolate_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteInterpolate process Invert Graphite Unit tests
func TestGraphiteInterpolate(t *testing.T) {
	RunTest(t, graphiteGraphiteInterpolate, "")
}

var graphiteGraphiteInterpolate = []unitTests{
