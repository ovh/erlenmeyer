...
// go test proto/prototests/graphite_keepLastValue_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteKeepLastValue process Invert Graphite Unit tests
func TestGraphiteKeepLastValue(t *testing.T) {
	RunTest(t, graphiteGraphiteKeepLastValue, "")
}

var graphiteGraphiteKeepLastValue = []unitTests{
