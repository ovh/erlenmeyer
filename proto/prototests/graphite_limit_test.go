...
// go test proto/prototests/graphite_limit_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteLimit process Invert Graphite Unit tests
func TestGraphiteLimit(t *testing.T) {
	RunTest(t, graphiteGraphiteLimit, "")
}

var graphiteGraphiteLimit = []unitTests{
