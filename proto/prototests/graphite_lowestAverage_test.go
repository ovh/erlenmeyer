...
// go test proto/prototests/graphite_lowestAverage_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteLowestAverage process Invert Graphite Unit tests
func TestGraphiteLowestAverage(t *testing.T) {
	RunTest(t, graphiteGraphiteLowestAverage, "")
}

var graphiteGraphiteLowestAverage = []unitTests{
