...
// go test proto/prototests/graphite_lowestCurrent_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteLowestCurrent process Invert Graphite Unit tests
func TestGraphiteLowestCurrent(t *testing.T) {
	RunTest(t, graphiteGraphiteLowestCurrent, "")
}

var graphiteGraphiteLowestCurrent = []unitTests{
