...
// go test proto/prototests/graphite_maxSeries_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteMaxSeries process Invert Graphite Unit tests
func TestGraphiteMaxSeries(t *testing.T) {
	RunTest(t, graphiteGraphiteMaxSeries, "")
}

var graphiteGraphiteMaxSeries = []unitTests{
