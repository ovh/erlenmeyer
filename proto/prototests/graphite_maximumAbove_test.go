...
// go test proto/prototests/graphite_maximumAbove_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteMaximumAbove process Invert Graphite Unit tests
func TestGraphiteMaximumAbove(t *testing.T) {
	RunTest(t, graphiteGraphiteMaximumAbove, "")
}

var graphiteGraphiteMaximumAbove = []unitTests{
