...
// go test proto/prototests/graphite_maximumBelow_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteMaximumBelow process Invert Graphite Unit tests
func TestGraphiteMaximumBelow(t *testing.T) {
	RunTest(t, graphiteGraphiteMaximumBelow, "")
}

var graphiteGraphiteMaximumBelow = []unitTests{

	{
		Plan: []graphite.Function{
			{
				Name:       "maximumBelow",
				Arguments:  []string{"SWAP", "102"},
