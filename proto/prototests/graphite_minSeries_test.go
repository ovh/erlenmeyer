...
// go test proto/prototests/graphite_minSeries_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteMinSeries process Invert Graphite Unit tests
func TestGraphiteMinSeries(t *testing.T) {
	RunTest(t, graphiteGraphiteMinSeries, "")
}

var graphiteGraphiteMinSeries = []unitTests{
