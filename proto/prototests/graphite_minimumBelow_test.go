...
// go test proto/prototests/graphite_minimumBelow_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteMinimumBelow process Invert Graphite Unit tests
func TestGraphiteMinimumBelow(t *testing.T) {
	RunTest(t, graphiteGraphiteMinimumBelow, "")
}

var graphiteGraphiteMinimumBelow = []unitTests{
