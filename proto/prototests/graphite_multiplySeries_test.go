...
// go test proto/prototests/graphite_multiplySeries_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteMultiplySeries process Invert Graphite Unit tests
func TestGraphiteMultiplySeries(t *testing.T) {
	RunTest(t, graphiteGraphiteMultiplySeries, "")
}

var graphiteGraphiteMultiplySeries = []unitTests{
