...
// go test proto/prototests/graphite_perSecond_test.go proto/prototests/exec_test.go -v
//

// TestGraphitePerSecond process Invert Graphite Unit tests
func TestGraphitePerSecond(t *testing.T) {
	RunTest(t, graphiteGraphitePerSecond, "")
}

var graphiteGraphitePerSecond = []unitTests{
		...
		Samples: []OperatorGTSTest{
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{25000000.000000, 0.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{0.000000, 0.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
