...
// go test proto/prototests/graphite_rangeOfSeries_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteRangeOfSeries process Invert Graphite Unit tests
func TestGraphiteRangeOfSeries(t *testing.T) {
	RunTest(t, graphiteGraphiteRangeOfSeries, "")
}

var graphiteGraphiteRangeOfSeries = []unitTests{
