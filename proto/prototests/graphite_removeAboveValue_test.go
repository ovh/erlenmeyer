...
// go test proto/prototests/graphite_removeAboveValue_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteRemoveAboveValue process Invert Graphite Unit tests
func TestGraphiteRemoveAboveValue(t *testing.T) {
	RunTest(t, graphiteGraphiteRemoveAboveValue, "")
}

var graphiteGraphiteRemoveAboveValue = []unitTests{
		...
		Samples: []OperatorGTSTest{
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{25000000.000000, 1.000000}, {85000000.000000, -0.333333}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Attrs:  map[string]string{},
						Values: [][]float64{{25000000.000000, 1.000000}, {85000000.000000, 2.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"other": "test", "label": "41"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{0.000000, 1.000000}, {35000000.000000, -1.000000}, {60000000.000000, 2.000000}, {72000000.000000, -2.000000}, {182000000.000000, -20.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"other": "test", "label": "41"},
						Attrs:  map[string]string{},
						Values: [][]float64{{0.000000, 1.000000}, {35000000.000000, 1.000000}, {60000000.000000, 2.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"other": "test", "label": "41"},
