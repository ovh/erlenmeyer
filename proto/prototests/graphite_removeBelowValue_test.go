...
// go test proto/prototests/graphite_removeBelowValue_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteRemoveBelowValue process Invert Graphite Unit tests
func TestGraphiteRemoveBelowValue(t *testing.T) {
	RunTest(t, graphiteGraphiteRemoveBelowValue, "")
}

var graphiteGraphiteRemoveBelowValue = []unitTests{
		...
		Samples: []OperatorGTSTest{
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{145000000.000000, 10.000000}, {205000000.000000, 32.666667}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Attrs:  map[string]string{},
						Values: [][]float64{{145000000.000000, 5.500000}, {205000000.000000, 9.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"other": "test", "label": "41"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{88000000.000000, 4.000000}, {112000000.000000, 8.000000}, {122000000.000000, 12.000000}, {132000000.000000, 16.000000}, {162000000.000000, 18.000000}, {202000000.000000, 100.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"other": "test", "label": "41"},
						Attrs:  map[string]string{},
						Values: [][]float64{{88000000.000000, 4.000000}, {112000000.000000, 5.000000}, {122000000.000000, 6.000000}, {132000000.000000, 7.000000}, {162000000.000000, 8.000000}, {182000000.000000, 9.000000}, {202000000.000000, 10.000000}},
					},
					{
						Class:  "sample",
