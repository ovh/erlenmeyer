...
// go test proto/prototests/graphite_removeEmptySeries_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteRemoveEmptySeries process Invert Graphite Unit tests
func TestGraphiteRemoveEmptySeries(t *testing.T) {
	RunTest(t, graphiteGraphiteRemoveEmptySeries, "")
}

var graphiteGraphiteRemoveEmptySeries = []unitTests{
