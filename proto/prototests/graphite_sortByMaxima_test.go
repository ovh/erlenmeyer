...
// go test proto/prototests/graphite_sortByMaxima_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteSortByMaxima process Invert Graphite Unit tests
func TestGraphiteSortByMaxima(t *testing.T) {
	RunTest(t, graphiteGraphiteSortByMaxima, "")
}

var graphiteGraphiteSortByMaxima = []unitTests{
