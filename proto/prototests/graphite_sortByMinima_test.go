...
// go test proto/prototests/graphite_sortByMinima_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteSortByMinima process Invert Graphite Unit tests
func TestGraphiteSortByMinima(t *testing.T) {
	RunTest(t, graphiteGraphiteSortByMinima, "")
}

var graphiteGraphiteSortByMinima = []unitTests{
