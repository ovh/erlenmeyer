...
// go test proto/prototests/graphite_sortByName_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteSortByName process Invert Graphite Unit tests
func TestGraphiteSortByName(t *testing.T) {
	RunTest(t, graphiteGraphiteSortByName, "")
}

var graphiteGraphiteSortByName = []unitTests{
