...
// go test proto/prototests/graphite_sortByTotal_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteSortByTotal process Invert Graphite Unit tests
func TestGraphiteSortByTotal(t *testing.T) {
	RunTest(t, graphiteGraphiteSortByTotal, "")
}

var graphiteGraphiteSortByTotal = []unitTests{
