...
// go test proto/prototests/graphite_sumSeriesWithWildcards_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteSumSeriesWithWildcards process Invert Graphite Unit tests
func TestGraphiteSumSeriesWithWildcards(t *testing.T) {
	RunTest(t, graphiteGraphiteSumSeriesWithWildcards, "")
}

var graphiteGraphiteSumSeriesWithWildcards = []unitTests{
