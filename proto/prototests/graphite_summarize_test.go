...
// go test proto/prototests/graphite_summarize_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteSummarize process Invert Graphite Unit tests
func TestGraphiteSummarize(t *testing.T) {
	RunTest(t, graphiteGraphiteSummarize, "")
}

var graphiteGraphiteSummarize = []unitTests{
		...
		Plan: []graphite.Function{
			{
				...
				Parameters: map[string]string{"span": "1 h"},
			},
		},
		Samples: []OperatorGTSTest{
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{3600000000.000000, 43.333333}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Attrs:  map[string]string{},
						Values: [][]float64{{3600000000.000000, 17.500000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "41", "other": "test"},
						Attrs:  map[string]string{},
						Values: [][]float64{{3600000000.000000, 4.000000}},
					},
				},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"label": "42"},
						Attrs:  map[string]string{},
						Values: [][]float64{{3600000000.000000, 137.000000}, {0.000000, 1.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"label": "42"},
			...
			},
			{
				...
				GTSResult: []FloatGeoTimeSeries{
					...
					},
					{
						...
						Labels: map[string]string{"other": "test", "label": "41"},
						Attrs:  map[string]string{},
						Values: [][]float64{{3600000000.000000, 55.000000}, {0.000000, 1.000000}},
					},
					{
						Class:  "sample",
						Labels: map[string]string{"other": "test", "label": "41"},
						Attrs:  map[string]string{},
						Values: [][]float64{{3600000000.000000, 7.000000}, {0.000000, 1.000000}},
					},
				},
