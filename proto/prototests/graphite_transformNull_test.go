...
// go test proto/prototests/graphite_transformNull_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteTransformNull process Invert Graphite Unit tests
func TestGraphiteTransformNull(t *testing.T) {
	RunTest(t, graphiteGraphiteTransformNull, "")
}

var graphiteGraphiteTransformNull = []unitTests{
