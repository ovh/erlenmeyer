...
// go test proto/prototests/graphite_unique_test.go proto/prototests/exec_test.go -v
//

// TestGraphiteUnique process Invert Graphite Unit tests
func TestGraphiteUnique(t *testing.T) {
	RunTest(t, graphiteGraphiteUnique, "")
}

var graphiteGraphiteUnique = []unitTests{
